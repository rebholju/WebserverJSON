...
* Therefore a Linkedlist is created form which the MQTTObject's could be added 
* and retrieved. The class is an extension of the class Thread form Java.lang.
*/
